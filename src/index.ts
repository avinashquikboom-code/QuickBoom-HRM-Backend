...
import salesExchangeWebhookController from './controllers/salesExchangeWebhookController';
import employeeWebhookController from './controllers/employeeWebhookController';
...
app.use('/api/webhook/commission', commissionWebhookController);
app.use('/api/webhook/creditNote', creditNoteWebhookController);
app.use('/api/webhook/salesExchange', salesExchangeWebhookController);
app.use('/api/webhook/employee', employeeWebhookController);
