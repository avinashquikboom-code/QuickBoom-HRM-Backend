      ...
      content: [
        ...
        },
        {
          columns: [
            {
              stack: [
                { text: 'HOPKID HRM  •  ENTERPRISE REPORTS', fontSize: 8, bold: true, color: PRIMARY_COLOR, margin: [0, -68, 0, 2] },
                { text: 'Comprehensive Attendance Report', fontSize: 16, bold: true, color: 'white', margin: [0, 0, 0, 2] },
                { text: `Organisation-wide detailed logs  •  Period: ${monthLabel}`, fontSize: 9, color: '#94A3B8' },
              ],
            },
            {
              stack: [
                { text: `Period: ${monthLabel}`, fontSize: 10, bold: true, color: 'white', alignment: 'right', margin: [0, -68, 0, 4] },
        ...
        // ── KPI SUMMARY STAT CARDS
        {
          columns: [
            {
              stack: [
                { text: totalRecords.toString(), fontSize: 20, bold: true, color: PRIMARY_COLOR, alignment: 'center' },
            ...
            {
              stack: [
                { text: totalPresent.toString(), fontSize: 20, bold: true, color: '#059669', alignment: 'center' },
            ...
            {
              stack: [
                { text: totalLate.toString(), fontSize: 20, bold: true, color: '#D97706', alignment: 'center' },
            ...
            {
              stack: [
                { text: totalAbsent.toString(), fontSize: 20, bold: true, color: '#DC2626', alignment: 'center' },
            ...
            {
              stack: [
                { text: avgWorkHoursStr, fontSize: 20, bold: true, color: '#6366F1', alignment: 'center' },
        ...
        ...employees.map((emp, index) => [
          {
            columns: [
              { text: `Employee: ${emp.firstName} ${emp.lastName} (${emp.employeeCode})`, bold: true, fontSize: 11, color: '#0F172A' },
              { text: `Department: ${emp.departmentName || 'Operations'}  •  Store: ${emp.officeName || 'Headquarters'}`, fontSize: 9, color: '#64748B', alignment: 'right' },
            ],
            margin: [0, 8, 0, 8],
            ...
            table: {
              ...
              body: [
                ...
                ...emp.attendances.map((att: any, i: number) => [
                  ...
                  { text: emp.employeeCode, fontSize: 7, color: '#64748B', fillColor: i % 2 === 0 ? '#F8FAFC' : 'white' },
                  { text: `${emp.firstName} ${emp.lastName}`, fontSize: 8, color: '#0F172A', fillColor: i % 2 === 0 ? '#F8FAFC' : 'white' },
                  { text: emp.officeName || 'Headquarters', fontSize: 8, color: '#64748B', fillColor: i % 2 === 0 ? '#F8FAFC' : 'white' },
                  { text: emp.departmentName || 'Operations', fontSize: 8, color: '#64748B', fillColor: i % 2 === 0 ? '#F8FAFC' : 'white' },
